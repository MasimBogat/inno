...
<head>
    ...
    <title>Belarusian state food industry concern BELGOSPISHCHEPROM</title>
    <meta name="description" content="Belarusian state food industry concern BELGOSPISHCHEPROM">
        ...
        <div class="container">
            <div class="inner _center h_between">
                ...
                <div class="w60 company-info">
                    <h1>Belarusian state food industry concern BELGOSPISHCHEPROM</h1>
                    ...
                    <ul class="company-contacts">
                        ...
                        <li>
                           ...
                           <span>Belarus, 220006, Minsk, 6 Aranskaya str.</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="inner _center">
                    <div class="info-wrap w100">
                        <p>The Belarussian State Concern of Food Industry Belgospishcheprom is the leading food producer. As concern we unite 46 companies, including companies of: sugar, confectionary, vegetable fat and oil, distillery, beer, tobacco and other branches of food industry.
                            </p>
                        <p>Key points:
                            <ul>
                                <li>includes 46 food producers</li>
                                <li>the annual volume of sales effected by the Сoncern’s enterprises exceeds 2 billion EURO per year </li>
                                ...
                                <li>annually the concern exports its products to more than 55 countries world wide</li>
                            </ul>
                        </p>
                    </div>
                </div>
                ...
                <div class="member-list">
                    <div class="inner _center">
                        <div class="member w30">
                            ...
                            <div class="member-name"><span>Volha Klimakova</span></div>
                            <div class="member-contacts">
                                <ul>
                                    <li id="job"><a href="#">Chief Specialist</a></li>
                ...
                <div class="stand-wrap">
                    ...
                    <div class="member-list">
                        <div class="member">
                            ...
                            <div class="info">
                                <div class="name"><h4>Aliaksandr Yakouchyts</h4></div>
                                <div class="position"><p>Deputy Chairman</p></div>
                            </div>
                        </div>
                        <div class="member">
                            <div class="photo"><img src="../images/company/company2(belgospisheprom)/person3.JPG" alt=""></div>
                            <div class="info">
                                <div class="name"><h4>Ihar Hrutsa</h4></div>
                                <div class="position"><p>Head of the Department of Foreign Economic Activity</p></div>
                            </div>
                        </div>
                    </div>
                </div>
